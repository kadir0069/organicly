    ...
    return (
        <section className="bg-[#E8F0EB] py-12 md:py-20 px-4 md:px-6">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Pricing Cards - Added justify-items-center for centering cards on mobile */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center justify-items-center">
                    {packages.map((pkg, index) => (
                        <div 
                            key={index}
                            // Fixed w-[364px] -> w-full max-w-[364px]
                            // Fixed h-[322px] -> min-h-[322px]
                        ...
                        >
                            ...
                            {/* Order Button */}
                            <button className="bg-[#067E51] text-white px-10 py-3 rounded-full font-semibold text-[16px] hover:bg-[#056342] transition-colors w-full sm:w-auto mt-auto">
                                অর্ডার করুন
                            </button>
                        </div>
                    ))}
